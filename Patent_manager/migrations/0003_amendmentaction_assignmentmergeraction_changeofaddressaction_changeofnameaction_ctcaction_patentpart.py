...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Patent_manager', '0002_delete_form_33_model'),
    ]

    operations = [
        migrations.CreateModel(
            name='AmendmentAction',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('official_fee', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True)),
                ('facilitation', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True)),
                ...
                ('applicable_service_charge', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True)),
                ('quickteller_fee', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='ProcurementOfCertificateAction',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('application_no', models.CharField(default='default value', max_length=50)),
                ('invention_description', models.CharField(default='default value', max_length=50)),
